...
function prepararLogin() {
    ...
    formulario.addEventListener('submit', evento => {
        ...
        if (clave.value === '') mensajeClave = 'La contraseña es obligatoria.';
        else if (clave.value.length < 4 || clave.value.length > 10)
            mensajeClave = 'La contraseña debe tener entre 4 y 10 caracteres.';

        const claveCorrecta = mostrarMensaje('error-login-clave', mensajeClave, 'error');
